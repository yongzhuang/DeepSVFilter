...
def trans2img(bam_path, sv_type, bed_path, output_dir, patch_size):
...
if __name__ == '__main__':
    sv_type='DUP'
    patch_size=224
    bam_path='/home/yzliu/deepsvfilter/results/HG002.hs37d5.60x.1.bam'
    bed_path='/data/yzliu/DeepSVFilter3/bed2img/test2.bed'
    output_imgs_dir='imgs_test'
    trans2img(bam_path, sv_type, bed_path, output_imgs_dir, patch_size)
